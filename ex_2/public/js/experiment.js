...
function generateFourDigits() {
    const digitslist = [0,3 ,5, 6, 8, 9];
    return Array.from({ length: 4 })
        .map(() => digitslist[Math.floor(Math.random() * digitslist.length)])
        .join('');
}
...
const instructions = {
    ...
    stimulus: `
        <h2>実験の手順</h2>
        <p>画面に表示される4桁の数字を読み取り<br>手元のキーボードで入力してください</p>
        <p>Enterキーで確定されます</p>
        <p>判読が困難な場合は<br><b>勘</b>、<b>読み取れた部分のみ</b>、<b>無記入</b><br>でも構いません</p>
        <hr>
        <h3>注意事項</h3>
        <ul>
            <li>試行中、顔の位置をできるだけ動かさないでください</li>
            <li>入力ミスには気を付けてください</li>
            <li>入力後は出来るだけ速やかにEnterキーを押してください</li>
        </ul>
        <hr>
        <p>まず、練習を1問行います</p>
    `,
...
const practice_parameters = [
    { period: 6, line_width: 3, angle: 45, text: '' , font_size: 32, stripe_color: 128 },
];

// 各パラメータを設定
for (let param of practice_parameters) {
    param.text = generateFourDigits();
}
...
const test_stripe_parameters = [
    { scale: '', period: 1, line_width: 0, angle: 0, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 5, line_width: 3, angle: 45, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 5, line_width: 4, angle: 45, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 6, line_width: 3, angle: 45, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 6, line_width: 4, angle: 45, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 5, line_width: 3, angle: 90, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 5, line_width: 4, angle: 90, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 6, line_width: 3, angle: 90, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 6, line_width: 4, angle: 90, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 5, line_width: 3, angle: 135, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 5, line_width: 4, angle: 135, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 6, line_width: 3, angle: 135, text: '', font_size: 32, stripe_color: 128 },
    { scale: '', period: 6, line_width: 4, angle: 135, text: '', font_size: 32, stripe_color: 128 },
];

const test_distances = shuffle([ 'intended', '100cm']);
